...
import catalogo28 from "@/assets/catalogo-28.jpg";
import catalogo29 from "@/assets/catalogo-29.jpg";
import catalogo30 from "@/assets/catalogo-30.jpg";
              ...
              <CarouselContent>
                ...
                <CarouselItem>
                  <div className="bg-card rounded-lg shadow-elegant overflow-hidden">
                    <img 
                      src={catalogo28} 
                      alt="Catálogo de Equipamentos de Proteção - Página 28" 
                      className="w-full h-auto object-contain"
                    />
                  </div>
                </CarouselItem>
                <CarouselItem>
                  <div className="bg-card rounded-lg shadow-elegant overflow-hidden">
                    <img 
                      src={catalogo29} 
                      alt="Catálogo de Equipamentos de Proteção - Página 29" 
                      className="w-full h-auto object-contain"
                    />
                  </div>
                </CarouselItem>
                <CarouselItem>
                  <div className="bg-card rounded-lg shadow-elegant overflow-hidden">
                    <img 
                      src={catalogo30} 
                      alt="Catálogo de Equipamentos de Proteção - Página 30" 
                      className="w-full h-auto object-contain"
                    />
                  </div>
                </CarouselItem>
                <CarouselItem>
                  <div className="bg-card rounded-lg shadow-elegant overflow-hidden">
                    <img 
                      src={catalogo31} 
                      alt="Catálogo de Equipamentos de Proteção - Página 31" 
                      className="w-full h-auto object-contain"
                    />
                  </div>
                </CarouselItem>
                <CarouselItem>
                  <div className="bg-card rounded-lg shadow-elegant overflow-hidden">
                    <img 
                      src={catalogo32} 
                      alt="Catálogo de Equipamentos de Proteção - Página 32" 
                      className="w-full h-auto object-contain"
                    />
                  </div>
                </CarouselItem>
